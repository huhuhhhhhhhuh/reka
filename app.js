...
{id:"a9", typeAward:"medal", sphere:"Сфера активности", subcat:"Общедоступные", name:"«За выдающиеся успехи в прокачивании Плавательных умений»", req:"Могут получить те, кто проявил особую решимость в прокачивании навыка, то есть достигли 9 уровня ПУ.", note:"Планируется замена медали на ачивку с частично иными требованиями. Если вы желаете получить именно медаль, постарайтесь успеть до сентября.", type:"toggle", image:"https://catwar.net/medal/613.png", blog:""},
...
{id:"a11", typeAward:"medal", sphere:"Сфера активности", subcat:"Общедоступные", name:"«За пыл, держащий на гребнях волн»", req:"Стать активистом недели (или месяца, если активиста недели в блоге/отряде нет) 12 и более раз в различной деятельности.", note:"Следует предоставить свой ID в сообщении, а также скриншоты становления активистами.", type:"counter", target:12, unit:"раз", image:"https://catwar.net/medal/5146.png", blog:""},
...
{id:"a14", typeAward:"medal", sphere:"Сфера активности", subcat:"Общедоступные", name:"«За неугасаемый огонь в глазах»",
  req:"Способы получения: будучи главой или заместителем, заработать 4 балла своевременными ежемесячными обновлениями или 15 баллов — иными видами обновлений блога; старшим воителям и должностям выше — набрать 4 балла за активную работу, включая период на ИС.",
  image:"https://catwar.net/medal/2967.png", blog:"",
  variants:[
    {label:"Глава/зам · в1", req:"Будучи главой или заместителем, заработать 4 балла своевременными ежемесячными обновлениями блога.", type:"counter", target:4, unit:"балла"},
    {label:"Глава/зам · в2", req:"Будучи главой или заместителем, заработать 15 баллов иными видами обновлений блога.", type:"counter", target:15, unit:"баллов"},
    {label:"Старшие воители и выше", req:"Набрать 4 балла за активную работу, включая период на ИС.", type:"counter", target:4, unit:"балла"}
  ]},
{id:"a15", typeAward:"medal", sphere:"Сфера активности", subcat:"Отрядные", name:"«За наблюдательность»",
  req:"1 способ получения: 50 дозоров ПЦ/ГБ; 20 участий в травнике и выполнений квестов или 20 переносов; 350 баллов в отряде; не иметь за собой серьёзных нарушений дисциплины. 2 способ получения: 550 баллов; не иметь за собой серьёзных нарушений дисциплины.",
  ...
  variants:[
    {label:"Способ 1", req:"50 дозоров ПЦ/ГБ; 20 участий в травнике и выполнений квестов (или 20 переносов); 350 баллов в отряде.", type:"multi", items: [ {key:"pts", label:"Баллы", type:"counter", target:350, unit:"баллов"}, {key:"pat", label:"Дозоры ПЦ/ГБ", type:"counter", target:50, unit:"дозоров"}, {key:"hrb", label:"Травник/квесты/переносы", type:"counter", target:20, unit:"участий"} ]},
    {label:"Способ 2", req:"Набрать 550 баллов суммарно.", type:"counter", target:550, unit:"баллов"}
  ]},
...
{id:"a18", typeAward:"medal", sphere:"Сфера активности", subcat:"Мероприятия", name:"«За волю к победе на мероприятии «Мир, труд, Река!»»", req:"Выдаётся победителям в одной из категорий ежегодного мероприятия «Мир, труд, Река!».", type:"toggle", image:"https://catwar.net/medal/4246.png", blog:""},
...
{id:"d3", typeAward:"medal", sphere:"Сфера детства", subcat:"Котячьи", name:"«За стремление к знаниям»", req:"Написать все 5 принятий на 10/10 без пересдач (или исправить недостающий балл написанием дополнительных принятий) в качестве Познающего.", type:"toggle", image:"https://catwar.net/medal/504.png", blog:"https://catwar.net/blog428342"},
...
{id:"d10", typeAward:"medal", sphere:"Сфера обучения", subcat:"Отрядные", name:"«За проверку племенных экзаменов»", req:"Проверить 15 ППП, 20 ВИ или 25 ПРИВ/УПРИВ, также нахождение на должности экзаменатора на протяжении минимум 2-ух месяцев.", image:"https://catwar.net/medal/246.png", blog:"",
  variants: [
    {label:"ППП", req:"Проверить 15 ППП и пробыть на должности экзаменатора минимум 2 месяца.", type:"multi", items: [ {key:"ppp", label:"Проверки ППП", type:"counter", target:15, unit:"шт"}, {key:"mon", label:"Стаж", type:"counter", target:2, unit:"мес"} ]},
    {label:"ВИ", req:"Проверить 20 ВИ и пробыть на должности экзаменатора минимум 2 месяца.", type:"multi", items: [ {key:"vi", label:"Проверки ВИ", type:"counter", target:20, unit:"шт"}, {key:"mon", label:"Стаж", type:"counter", target:2, unit:"мес"} ]},
    {label:"ПРИВ/УПРИВ", req:"Проверить 25 ПРИВ/УПРИВ и пробыть на должности экзаменатора минимум 2 месяца.", type:"multi", items: [ {key:"priv", label:"Проверки ПРИВ", type:"counter", target:25, unit:"шт"}, {key:"mon", label:"Стаж", type:"counter", target:2, unit:"мес"} ]}
  ]
},
...
{id:"b1", typeAward:"medal", sphere:"Сфера безопасности и бойцов", subcat:"Общедоступные", name:"«За выдающиеся боевые умения»", req:"Могут получить те, кто проявил особую решимость в прокачивании навыка, то есть достигли 9 уровня БУ.", type:"toggle", image:"https://catwar.net/medal/188.png", blog:""},
...
{id:"b5", typeAward:"medal", sphere:"Сфера безопасности и бойцов", subcat:"Отрядные", name:"«За воспитание воинского духа и обучение боевому искусству»", req:"Провести определённое количество тренировок: 15 для Учителя, 20 для Старосты или 25 для Знатока.", image:"https://catwar.net/medal/611.png", blog:"https://catwar.net/blog268845",
  variants:[
    {label:"Учитель", req:"Провести 15 тренировок в роли Учителя.", type:"counter", target:15, unit:"тренировок"},
    {label:"Староста", req:"Провести 20 тренировок в роли Старосты.", type:"counter", target:20, unit:"тренировок"},
    {label:"Знаток", req:"Провести 25 тренировок в роли Знатока.", type:"counter", target:25, unit:"тренировок"}
  ]},
{id:"b6", typeAward:"medal", sphere:"Сфера безопасности и бойцов", subcat:"Отрядные", name:"«Никто не в силах разделить нас, пока свет указывает путь»", req:"Набегать 10 часов во время боевого обмена между фракциями.", type:"counter", target:600, unit:"минут", image:"https://catwar.net/medal/2690.png", blog:""},
{id:"b7", typeAward:"medal", sphere:"Сфера безопасности и бойцов", subcat:"Отрядные", name:"«За каменный след там, где билось сердце»", req:"Накопить 20 баллов за деятельность в отряде Киллеров, которая включает в себя убийства нарушителей, их выслеживание и многое другое.", type:"counter", target:20, unit:"баллов", image:"https://catwar.net/medal/5261.png", blog:"https://catwar.net/blog13647"},
...
{id:"c1", typeAward:"medal", sphere:"Сфера художества", subcat:"Общедоступные", name:"«За создание красочных пейзажей»", req:"Отрисовать 4 любых полноценных фона для локаций племени (на постоянную основу или для мероприятий).", type:"counter", target:4, unit:"фонов", image:"https://catwar.net/medal/610.png", blog:"https://catwar.net/blog865117"},
...
{id:"c3", typeAward:"medal", sphere:"Сфера творчества", subcat:"Отрядные", name:"«За переданные послания звёзд»", req:"Набрать 75 баллов.", type:"counter", target:75, unit:"баллов", image:"https://catwar.net/medal/1715.png", blog:"https://catwar.net/blog47872"},
...
{id:"c6", typeAward:"medal", sphere:"Сфера творчества", subcat:"Отрядные", name:"«За искусное владение пером»", req:"Достичь 30 баллов и состоять в отряде Журналистов минимум 2 месяца.", note:"На данный момент получение затруднено из-за проводящейся реформы отряда.", type:"multi", items: [ {key:"pts", label:"Баллы", type:"counter", target:30, unit:"баллов"}, {key:"mon", label:"Месяцы в отряде", type:"counter", target:2, unit:"мес"} ], image:"https://catwar.net/medal/3375.png", blog:"https://catwar.net/blog434004"},
{id:"c7", typeAward:"medal", sphere:"Сфера творчества", subcat:"Отрядные", name:"«За создание сюжетов, трогающих душу»", req:"Набрать 100 баллов за проведение мафии.", note:"На данный момент получение затруднено из-за проводящейся реформы отряда.", type:"counter", target:100, unit:"баллов", image:"https://catwar.net/medal/3374.png", blog:"https://catwar.net/blog931073"},
{id:"sp1", typeAward:"medal", sphere:"Особые медали", subcat:"Общедоступные", name:"«За активное участие в жизни племени»",
  ...
  variants: [
    {label:"Охраняющие (минуты)", req:"8+ ПУ или БУ; собрано 3 медали; отходить 2400 минут в дозорах.", type:"multi", items: [{key:"lvl", label:"8+ ПУ или БУ", type:"toggle"}, {key:"med", label:"Собрано 3 медали", type:"toggle"}, {key:"prc", label:"Дозоры", type:"counter", target:2400, unit:"мин"}]},
    {label:"Охраняющие (патрули)", req:"8+ ПУ или БУ; собрано 3 медали; посетить 40 патрулей.", type:"multi", items: [{key:"lvl", label:"8+ ПУ или БУ", type:"toggle"}, {key:"med", label:"Собрано 3 медали", type:"toggle"}, {key:"prc", label:"Патрули", type:"counter", target:40, unit:"шт"}]},
    {label:"Охотники", req:"8+ ПУ или БУ; собрано 3 медали; набрать 70 баллов за охоту.", type:"multi", items: [{key:"lvl", label:"8+ ПУ или БУ", type:"toggle"}, {key:"med", label:"Собрано 3 медали", type:"toggle"}, {key:"prc", label:"Охота", type:"counter", target:70, unit:"баллов"}]},
    {label:"Травники", req:"8+ ПУ или БУ; собрано 3 медали; набрать 20 баллов у Травников.", type:"multi", items: [{key:"lvl", label:"8+ ПУ или БУ", type:"toggle"}, {key:"med", label:"Собрано 3 медали", type:"toggle"}, {key:"prc", label:"Травники", type:"counter", target:20, unit:"баллов"}]},
    {label:"Покорители", req:"8+ ПУ или БУ; собрано 3 медали; посетить 10 патрулей за мхом.", type:"multi", items: [{key:"lvl", label:"8+ ПУ или БУ", type:"toggle"}, {key:"med", label:"Собрано 3 медали", type:"toggle"}, {key:"prc", label:"Патрули за мхом", type:"counter", target:10, unit:"шт"}]},
    {label:"Туннелеры", req:"8+ ПУ или БУ; собрано 3 медали; посетить 10 паутинников.", type:"multi", items: [{key:"lvl", label:"8+ ПУ или БУ", type:"toggle"}, {key:"med", label:"Собрано 3 медали", type:"toggle"}, {key:"prc", label:"Паутинники", type:"counter", target:10, unit:"шт"}]},
    {label:"Скалолазы", req:"8+ ПУ или БУ; собрано 3 медали; посетить 12 сборов со скал.", type:"multi", items: [{key:"lvl", label:"8+ ПУ или БУ", type:"toggle"}, {key:"med", label:"Собрано 3 медали", type:"toggle"}, {key:"prc", label:"Сборы со скал", type:"counter", target:12, unit:"шт"}]}
  ],
...
{id:"ac3", typeAward:"achievement", sphere:"Сфера детства", subcat:"Общедоступные", name:"«Давай, нападай!»", req:"Активировать котятам красивую бабочку 500 раз.", type:"counter", target:500, unit:"раз", image:"https://i.yapx.cc/X6RSV.png", blog:"https://catwar.net/blog15700"},
...
{id:"ac6", typeAward:"achievement", sphere:"Сфера ресурсов", subcat:"Скалолазы", name:"«Расхититель орлиных гнёзд»", req:"Набрать не менее 75 баллов.", type:"counter", target:75, unit:"баллов", image:"https://i.yapx.cc/Yg3dI.png", blog:"https://catwar.net/blog1091768"},
{id:"ac7", typeAward:"achievement", sphere:"Сфера безопасности и бойцов", subcat:"Боевые", name:"«Завсегдатай арены»", req:"Посетить 80 тренировок.", type:"counter", target:80, unit:"тренировок", image:"https://i.yapx.cc/X661C.png", blog:"https://catwar.net/blog268845"},
{id:"ac8", typeAward:"achievement", sphere:"Сфера безопасности и бойцов", subcat:"Боевые", name:"«Всё под контролем»", req:"Принять активную организаторскую деятельность в Орденах.", type:"toggle", image:"https://i.yapx.cc/XrSMg.png", blog:"https://catwar.net/blog268845"},
...
{id:"ac17", typeAward:"achievement", sphere:"Сфера активности", subcat:"Отрядные", name:"«Преданный делу»", req:"Получение данной награды возможно за работу в любом Речном отряде более 6 месяцев и наличие медали того отряда, за счёт которого игрок претендует на ачивку.", type:"toggle", image:"https://i.yapx.cc/X0cA8.png", blog:""},
{id:"ac18", typeAward:"achievement", sphere:"Сфера обучения", subcat:"Отрядные", name:"«За кураторство»", req:"Выдаётся за выполнение требований, указанных в блогах отрядов: Целительский уголок, Мастера игр, Воспитатели, Мафиози и Поздравители.", type:"toggle", image:"https://i.yapx.cc/X0cGL.png", blog:"https://catwar.net/blog291989"},
...
{id:"ac20", typeAward:"achievement", sphere:"Сфера творчества", subcat:"Творцы", name:"«Вся жизнь — театр»", req:"Претендовать на данную ачивку могут Актёры, отыгравшие свою роль в сумме не менее 25 часов.", type:"counter", target:1500, unit:"минут", image:"https://i.yapx.cc/X6RvB.png", blog:"https://catwar.net/blog971489"},
...
{id:"ac31", typeAward:"achievement", sphere:"Сфера художества", subcat:"Иллюстраторы", name:"«Ювелирных дел мастер»", req:"Отрисовать 5 работ маленького разрешения (исключая работы для мероприятий).", type:"counter", target:5, unit:"работ", image:"https://i.yapx.cc/X0fWy.png", blog:"https://catwar.net/blog865117"},
...
{id:"ac33", typeAward:"achievement", sphere:"Сфера художества", subcat:"Иллюстраторы", name:"«Я в порядке»", req:"Отрисовать минимум 3 работы с дедлайном менее недели (исключая работы для журнала).", type:"counter", target:3, unit:"работ", image:"https://i.yapx.cc/X0fYM.png", blog:"https://catwar.net/blog865117"},
...
<input type="number" min="0" value="${val || ''}" data-id="${mId}" data-variant="${vIdx != null ? vIdx : ""}" data-mkey="${it.key}" class="multi-counter-input">          <span class="of-target mono">/ ${it.target} ${it.unit || ""}</span>
        </div>
      </div>`;
    }
  }).join("");
